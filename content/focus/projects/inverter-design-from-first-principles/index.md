...
following:
  ...
  ----------------------------------------------------------------------------------------------------------------
       $$V_{out} = \frac{I_{out}.T}{{4.C}_{out.}2} = \frac{{(\mathrm{\Delta}I}_{out)}.T}{{8.C}_{out}}$$   *(21)*
  ---- -------------------------------------------------------------------------------------------------- --------
...
formula.
  ...
  -------------------------------------------------------------------------------------------
       $$C_{out} = \frac{{\mathrm{\Delta}I}_{out}}{{8.f.\mathrm{\Delta}V}_{out}}$$   *(22)*
  ---- ----------------------------------------------------------------------------- --------
...
capacitor value and therefore a smoother output.
  ...
  ---------------------------------------------------------------------------
       $$C_{out} = \frac{0,1.I_{out}}{{8.f.(0,005V}_{out})}$$        *(23)*
  ---- ------------------------------------------------------------- --------
...
Once the values get substituted in the above equation;
  ...
  -----------------------------------------------------------------------------------------------------------
  $$C_{out} = \frac{0.1 \times 5.88}{8 \times 25 \times 10^{3} \times (0.005 \times 17)} = 345uF$$   *(24)*
  -------------------------------------------------------------------------------------------------- --------
